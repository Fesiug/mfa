...
SWEP.RecoilFlipChance					= ( 4 / 5 ) -- chance to flip recoil direction
...
SWEP.Recoil2UpDecay						= 12 -- how much recoil to remove per second
SWEP.Recoil2SideDecay					= 12 
...
SWEP.Animations = {
	...
	["reload_empty"] = {
		...
		Events = {
			...
			{ t = 4.4, s = "mfa/wep/ogg/Reload_1P_AK12_Bolt_Wave 0 0 0.ogg" },
